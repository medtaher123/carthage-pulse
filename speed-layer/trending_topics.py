...
from event_json_types import raw_event_json_schema, enriched_event_json_schema
from spark_columns import get_raw_columns, get_enriched_columns
from trending_topics_utils import extract_trending_topics  # Import the new transformer
