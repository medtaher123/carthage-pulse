...
from kafka_utils import SPARK_CONNECT_TARGET, read_from_kafka, RAW_EVENTS_KAFKA_TOPIC
...
from word_count_utils import extract_trending_words # Assuming you saved the transformer here
